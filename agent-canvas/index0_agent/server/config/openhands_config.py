...
from index0_agent.server.types import AppMode, OpenhandsConfigInterface
...
class OpenhandsConfig(OpenhandsConfigInterface):
    ...
    attach_conversation_middleware_path = (
        'index0_agent.server.middleware.AttachConversationMiddleware'
    )
    settings_store_class: str = (
        'index0_agent.storage.settings.file_settings_store.FileSettingsStore'
    )
    conversation_store_class: str = (
        'index0_agent.storage.conversation.file_conversation_store.FileConversationStore'
    )
