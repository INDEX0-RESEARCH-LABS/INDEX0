...
from index0_agent.core.main import create_runtime, run_controller
from index0_agent.events.action import CmdRunAction, MessageAction
from index0_agent.events.observation import (
    CmdOutputObservation,
    ErrorObservation,
    Observation,
)
from index0_agent.events.stream import EventStreamSubscriber
from index0_agent.resolver.github_issue import GithubIssue
from index0_agent.resolver.issue_definitions import (
    IssueHandler,
    IssueHandlerInterface,
    PRHandler,
)
from index0_agent.resolver.resolver_output import ResolverOutput
from index0_agent.resolver.utils import (
...
def main():
    ...
    if runtime_container_image is None:
        runtime_container_image = (
            f'ghcr.io/all-hands-ai/runtime:{index0_agent.__version__}-nikolaik'
        )
