...
from index0_agent.core.config import OH_DEFAULT_AGENT, OH_MAX_ITERATIONS, get_parser
...
def test_help_message(capsys):
    ...
    for element in expected_elements:
        alt_element = re.sub(r'-([a-zA-Z]) [A-Z_]+, --', r'-\1, --', element)
        assert (element in help_output or alt_element in help_output), f"Expected '{element}' or '{alt_element}' to be in the help message"
