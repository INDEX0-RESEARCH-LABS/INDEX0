...
from index0_agent.core.exceptions import UserCancelledError
from index0_agent.llm.async_llm import AsyncLLM
from index0_agent.llm.llm import LLM
from index0_agent.llm.streaming_llm import StreamingLLM
...
@contextmanager
def _patch_http():
    with patch('index0_agent.llm.llm.requests.get', MagicMock()) as mock_http:
