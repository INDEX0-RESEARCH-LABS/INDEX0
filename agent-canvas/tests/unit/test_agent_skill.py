...
from index0_agent.runtime.plugins.agent_skills.file_ops.file_ops import (
    WINDOW,
    _print_window,
    find_file,
    goto_line,
...
from index0_agent.runtime.plugins.agent_skills.file_reader.file_readers import (
    parse_docx,
    parse_latex,
    parse_pdf,
    parse_pptx,
...
def reset_current_file():
    from index0_agent.runtime.plugins.agent_skills import agentskills
