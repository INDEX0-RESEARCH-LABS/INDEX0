...
from index0_agent.utils.microagent import MicroAgent
...
def prompt_dir(tmp_path):
    ...
    shutil.copytree(
        'index0_agent/agenthub/codeact_agent/prompts', tmp_path, dirs_exist_ok=True
    )
...
"""
    ...
    assert (
        'You are INDEX0 AI, an enterprise autonomous software engineering agent.'
