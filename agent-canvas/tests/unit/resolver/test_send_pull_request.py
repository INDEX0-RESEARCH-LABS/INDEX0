...
from index0_agent.core.config import LLMConfig
from index0_agent.resolver.github_issue import ReviewThread
from index0_agent.resolver.resolver_output import GithubIssue, ResolverOutput
from index0_agent.resolver.send_pull_request import (
    apply_patch,
    initialize_repo,
...
@patch('index0_agent.resolver.send_pull_request.reply_to_comment')
@patch('requests.post')
@patch('subprocess.run')
@patch('index0_agent.resolver.send_pull_request.LLM')
...
@patch('index0_agent.resolver.send_pull_request.initialize_repo')
@patch('index0_agent.resolver.send_pull_request.apply_patch')
@patch('index0_agent.resolver.send_pull_request.update_existing_pull_request')
@patch('index0_agent.resolver.send_pull_request.make_commit')
...
@patch('index0_agent.resolver.send_pull_request.initialize_repo')
@patch('index0_agent.resolver.send_pull_request.apply_patch')
@patch('index0_agent.resolver.send_pull_request.send_pull_request')
@patch('index0_agent.resolver.send_pull_request.make_commit')
...
@patch('index0_agent.resolver.send_pull_request.load_all_resolver_outputs')
@patch('index0_agent.resolver.send_pull_request.process_single_issue')
...
@patch('index0_agent.resolver.send_pull_request.argparse.ArgumentParser')
@patch('index0_agent.resolver.send_pull_request.process_all_successful_issues')
@patch('index0_agent.resolver.send_pull_request.process_single_issue')
@patch('index0_agent.resolver.send_pull_request.load_single_resolver_output')
...
def test_main(
    ...
    from index0_agent.resolver.send_pull_request import main
