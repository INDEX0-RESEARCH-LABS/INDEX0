...
from index0_agent.resolver.send_pull_request import make_commit
...
def test_pr_title_with_quotes(monkeypatch):
    ...
    monkeypatch.setattr(
        'index0_agent.resolver.send_pull_request.branch_exists',
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        print('Sending PR...')
        from index0_agent.resolver.send_pull_request import send_pull_request
